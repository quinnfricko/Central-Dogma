...
class Dots_and_Boxes():
    ...
    def play_again(self):
        ...
        self.blue_starts = not self.blue_starts
        self.blue_turn = not self.blue_starts
    ...
    def display_gameover(self):
        blue_score = len(np.argwhere(self.board_status == -4))
        player2_score = len(np.argwhere(self.board_status == 4))

        if blue_score > player2_score:
            # Player 1 wins
            text = 'Congratulations!'
            color = blue_color
        elif player2_score > blue_score:
            text = 'Congratulations!'
            color = player2_color
        else:
            text = 'Nice!'
        ...
        score_text = 'Exon : ' + str(blue_score) + '\n'
        score_text += 'Intron : ' + str(player2_score) + '\n'
